...
I strongly believe AI has the potential to significantly enhance the quality of existing teaching materials. With AI agents like ChatGPT Assistant, educators can feed their learning materials into a context library, enabling students to receive personalized answers to their questions without delays in the ask-and-answer process. However, I don’t think students should be allowed or encouraged to use AI during WODs, as these exercises are a vital part of the current ICS 314 curriculum that help students deepen their understanding of core concepts.

# VIII. Conclusion
Using AI in the Software Engineering course has been incredibly helpful for handling repetitive tasks like code documentation and refining essays, giving me more time to focus on understanding key concepts. However, I think students should not to rely on AI for exercises like WODs, where the goal was to build our problem-solving and coding skills. While AI is great for speeding up certain tasks, it’s not perfect and sometimes struggles with complex problems without enough context. To improve its use in future courses, educators can provide students with access to AI agents like ChatGPT Assistant, which can be customized to match course materials. Clear guidelines should also be in place to ensure students benefit from AI without over-relying on it.